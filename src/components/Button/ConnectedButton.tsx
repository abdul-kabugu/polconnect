    ...
    const {themeConfig, activeChain, activeAccount, handleDisconnectModal, handleSwitchChains} = usePolkit()
     ...
     const renderByLibraryTheme = () =>  {
        if(themeConfig === "light"){
            return(
                <div className="inline-flex gap-3 border border-gray-300/30 py-1 px-1 rounded-lg shadow-md">
             ...
             <div className="flex items-center justify-center gap-1 ">
              <p className="capitalize font-medium font-sans  text-black/70 hover:text-black"> {activeChain?.name} </p>
