...
export default function ConnectModal({chain} : connectModalProps) {
    const {themeConfig,
       handleConnectModal,
        connect,
         activeExtension,
 ...
 const handleOpenExternalLink = (linkUrl : string) => {
  ...
  <div className={`w-[310px] animate-fromDownFade duration-500 h-[420px] border   ${themeConfig === "dark" ? "border-gray-700/70 bg-gray-900 text-gray-300/75"  : "border-black/30 bg-white/90"} rounded-xl p-3`}>
     {/*Start component  header */}
       ...
       <div className="flex justify-between items-center "> 
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-5 h-5 cursor-pointer ${themeConfig === "dark" ? "text-gray-200/100" : "text-gray-700"} `} onClick={showAboutWallet}>
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
</svg>

  <h1 className='font-semibold text-lg'> Connect Wallet </h1>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-5 h-5 cursor-pointer ${themeConfig === "dark" ? "text-gray-200/100" :  "text-gray-700"} `} onClick={handleConnectModal}>
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
     ...
     {allDefaultWallets?.map((wallet, i) => (
        <div key={i} className={`flex justify-between border ${themeConfig === "dark" && "border-gray-700/70 hover:border-gray-700/60"} border-gray-300/80 py-1.5 px-3 rounded-md cursor-pointer hover:animate-scaleSlow hover:border-gray-400 my-5`} onClick={() => walletConnector(chain || activeChain, wallet)}>
        <h2 className="capitalize font-medium "> {wallet.name}</h2>
         <img  src={wallet?.logoUrls[0]} className="w-7 h-7 rounded-full"   />
        </div>
        ))}
        
        <div className={`flex gap-2 items-center justify-center ${themeConfig === "dark" ? "text-gray-400 hover:text-gray-300" : "text-gray-500 hover:text-gray-800"} cursor-pointer  text-sm`} onClick={showNoWallet}> 
    ...
    return(
      ...
      <div className={`w-[280px] h-[425px] border ${themeConfig === "dark" ? "border-gray-600/30 bg-gray-900  text-gray-300" : "bg-white/90 border-gray-600/30"}  rounded-xl p-4  animate-slideAndFade`}>
        {/*} Start component  header */}
           ...
           <div className="flex justify-between items-center "> 
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-5 h-5 cursor-pointer ${themeConfig === "dark" ? "text-gray-200/100" :  "text-gray-700"} `} onClick={showConnectWallet}>
      ...
      <div className="mt-6">
        ...
        <p className="text-center font-light "> These wallets empower you to transmit, accept, safeguard, and engage with digital assets, such as NFTs and various Polkadot and Kusama tokens.</p>
         ...
         <div className={`my-3 flex gap-3 items-center justify-center border ${themeConfig === "dark" ? "border-gray-700/60" : "border-gray-300/70"}  py-2 px-3 rounded-lg cursor-pointer hover:animate-scaleSlow`} onClick={() => handleOpenExternalLink("https://wiki.polkadot.network/docs/wallets-and-extensions")}>
...
<div className={`w-[320px] animate-slideAndFade h-[370px] ${themeConfig === "dark" ? "bg-gray-900 border-gray-300/30 text-gray-300" : "border-gray-600/30  bg-white/90"} border  rounded-xl p-4 `}>
  ...
  <div className="mt-6">
    ...
    <p className={`text-center ${themeConfig === "dark" && "text-gray-400"} `}>To connect your {selectedWallet?.name},
...
<div className={`w-[320px] animate-slideAndFade h-[340px] ${themeConfig === "dark" ? "bg-gray-900 border-gray-300/30 text-gray-300" : "border-gray-600/30  bg-white/90"} border  rounded-xl p-4 `}>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
     ...
     <div className="mt-5">
          <div className={` rounded-lg py-2 flex items-center justify-center`}>
                <svg aria-hidden="true" className={`w-[110px] h-[110px] mr-2 ${themeConfig === "dark" ? "text-gray-800" : "text-gray-100 "} animate-spin  fill-pink-600`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="mt-6">
    ...
    <p className={`text-center ${themeConfig === "dark" && "text-gray-400"} `}>Accept the request through your wallet to connect to this app.</p>
